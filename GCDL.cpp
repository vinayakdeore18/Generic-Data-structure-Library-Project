...
//
//  Class Name :        SinglyLL 
//  Description :       used to implement Singly Linear LinkedList functions in generic Way
//  Input :             Any datatypes
//  Output :            Depends 
...
//
//  Class Name :        DoublyLL
//  Description :       used to implement Doubly Linear LinkedList functions in generic Way
//  Input :             Any datatypes
//  Output :            Depends 
//  Author :            Vinayak Sudam Deore
//  Date :              27/06/2024
...
//
//  Class Name :        SinglyCL 
//  Description :       used to implement Singly Circular LinkedList functions in generic Way
//  Input :             Any datatypes
//  Output :            Depends 
//  Author :            Vinayak Sudam Deore
//  Date :              27/06/2024
...
//
//  Class Name :        DoublyCL
//  Description :       used to implement Doubly Circular LinkedList functions in generic Way
//  Input :             Any datatypes
//  Output :            Depends 
//  Author :            Vinayak Sudam Deore
//  Date :              01/07/2024
...
//
//  Class Name :        Stack 
//  Description :       used to implement Stack functions in generic Way
//  Input :             Any datatypes
//  Output :            Depends 
//  Author :            Vinayak Sudam Deore
//  Date :              01/07/2024
...
//
//  Class Name :        Queue
//  Description :       used to implement Queue functions in generic Way
//  Input :             Any datatypes
//  Output :            Depends 
//  Author :            Vinayak Sudam Deore
//  Date :              16/04/2024
...
//
//  Class Name :        Tree
//  Description :       used to implement BST functions in generic Way
//  Input :             Any datatypes
//  Output :            Depends 
//  Author :            Vinayak Sudam Deore
//  Date :              04/07/2024
...
void Tree<T>::Insert(T No)
 {
    ...
    else
    {
        ...
        while(1)
        {
            if(temp->data == No)
            {
                cout<<"Unable to insert as elements is already present \n";
                delete newn;
                break; 
            }
...
template<class T>
void Tree<T>::Inorder(struct nodeBST<T> * Root)
{
    if(Root != NULL)
    {
        Inorder(Root->lchild);
...
template<class T>
void Tree<T>::Preorder(struct nodeBST<T> * Root)
{
    if(Root != NULL)
    {
        cout<<Root->data<<"\n ";
 ...
 template<class T>
void Tree<T>::Postorder(struct nodeBST<T> * Root)
{
    if(Root != NULL)
    {
...
template<class T>
int Tree<T>::CountLeaf(struct nodeBST<T> * Root)
{
     if(Root == NULL)
     {
        return 0;
...
template<class T>
int Tree<T>::CountParent(struct nodeBST<T> * Root)
{
     static int iCnt =0;
...
template<class T>
int Tree<T>::CountAll(struct nodeBST<T> * Root)
{
      static int iCnt = 0;
...
///////////////////////////////////////////////////////////////////////////////////
//
//   Code Of Searching & Sorting Algorithms
//
//////////////////////////////////////////////////////////////////////////////////////////////////
//
//  Class Name :        ArrayX
//  Description :       used to implement Searching & Sorting Algorithms  functions in generic Way
//  Input :             Any datatypes
//  Output :            Depends 
//  Author :            Vinayak Sudam Deore
//  Date :              17/07/2024
...
template<class T>
void ArrayX<T>::InsertionSort()   // its efficiently work for small set of datasets 
{
    int i =0, j =0;
    T selected ;
...
/////////////////////////////////////////////////////////////////////////
//
// Code of Addtional Functions
//
/////////////////////////////////////////////////////////////////////////////////////////////////
//
//  Class Name :        Extra 
//  Description :       try to implement some Additional functions using Linkedlist 
//  Input :             Any datatypes
//  Output :            Depends 
//  Author :            Vinayak Sudam Deore
//  Date :              17/07/2024
...
template<class T>
int Extra<T>::SearchFirstOccurance(T No)
{
    int fCount =1;
    int iPos = -1;
    struct node<T> * temp = First;
...
template<class T>
int Extra<T>::SearchLastOccurance(T No)
{
    int lCount = 1;
    int iPos = -1;
...
template<class T>
T Extra<T>::FactorsAddition(T No)
{
    T Sum =0;
    int i = 0;
...
template<class T>
bool Extra<T>::CheckPerfect(T No)     // This code will only work for int 
{
    int iSum =0 , i  =0;
...
template<class T>
void Extra<T>::DisplayPerfect()  // this code will only work for int
{
    struct node<T> *temp = First;
    ...
    while(temp != NULL)
    {
        ...
        {
            cout<<"Perfect numer from LL is :"<<temp->data<<"\n";
        }
        temp = temp->next;
    }
}
...
template<class T>
T Extra<T>::MiddleElementX()
{
    struct node<T> * Teacher = First;
    struct node<T> * Student = First;
...
template<class T>
bool Extra<T>::CheckLoop()   //  infinite loop
{
    struct node<T>* Teacher = First;
    struct node<T> * Student = First;
    bool bFlag = false;
...
template<class T>
void Extra<T>::Reverse()
{
    struct node<T> * Previous = NULL;
